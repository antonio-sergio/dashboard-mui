...
const loadingSteps = [
  { label: 'Verificando API do helix-app' },
  { label: 'Verificando conexão com o banco de dados do Tasy' },
  { label: 'Verificando últimos alertas' },
  { label: 'Buscando follow-ups ativos' },
];
    ...
    <>
      {!loaded ? (
        <ServiceLoadingScreen
          ...
          delay={1500} // 1s entre cada passo
        />
      ) : (
